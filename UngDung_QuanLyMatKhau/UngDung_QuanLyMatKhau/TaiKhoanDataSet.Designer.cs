...
namespace UngDung_QuanLyMatKhau {
    ...
    public partial class TaiKhoanDataSet : global::System.Data.DataSet {
        ...
        public partial class TaiKhoanDataTable : global::System.Data.TypedTableBase<TaiKhoanRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TaiKhoanRow AddTaiKhoanRow(string TaiKhoan, string MatKhau, string Note) {
        ...
        public partial class TaiKhoanRow : global::System.Data.DataRow {
            ...
            public string Note {
                get {
                    try {
                        return ((string)(this[this.tableTaiKhoan.NoteColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Note\' in table \'TaiKhoan\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTaiKhoan.NoteColumn] = value;
                }
            }
            ...
            public bool IsNoteNull() {
                return this.IsNull(this.tableTaiKhoan.NoteColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetNoteNull() {
                this[this.tableTaiKhoan.NoteColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace UngDung_QuanLyMatKhau.TaiKhoanDataSetTableAdapters {
    ...
    public partial class TaiKhoanTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [TaiKhoan] WHERE (((@IsNull_TaiKhoan = 1 AND [TaiKhoan] IS NULL) OR ([TaiKhoan] = @Original_TaiKhoan)) AND ((@IsNull_MatKhau = 1 AND [MatKhau] IS NULL) OR ([MatKhau] = @Original_MatKhau)) AND ((@IsNull_Note = 1 AND [Note] IS NULL) OR ([Note] = @Original_Note)) AND ([Id] = @Original_Id))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [TaiKhoan] ([TaiKhoan], [MatKhau], [Note]) VALUES (@TaiKhoan, @MatKha" +
                "u, @Note);\r\nSELECT TaiKhoan, MatKhau, Note, Id FROM TaiKhoan WHERE (Id = SCOPE_I" +
                "DENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [TaiKhoan] SET [TaiKhoan] = @TaiKhoan, [MatKhau] = @MatKhau, [Note] = @Note WHERE (((@IsNull_TaiKhoan = 1 AND [TaiKhoan] IS NULL) OR ([TaiKhoan] = @Original_TaiKhoan)) AND ((@IsNull_MatKhau = 1 AND [MatKhau] IS NULL) OR ([MatKhau] = @Original_MatKhau)) AND ((@IsNull_Note = 1 AND [Note] IS NULL) OR ([Note] = @Original_Note)) AND ([Id] = @Original_Id));
SELECT TaiKhoan, MatKhau, Note, Id FROM TaiKhoan WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::UngDung_QuanLyMatKhau.Properties.Settings.Default.TaiKhoanConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TaiKhoan, MatKhau, Note, Id FROM TaiKhoan";
